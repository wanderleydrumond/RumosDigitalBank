...
public class AccountListRepositoryImplementation {
    private ArrayList<DebitCard> debitCards;
    private ArrayList<CreditCard> creditCards;
    private ArrayList<Account> accountsBankList;

    public AccountListRepositoryImplementation() {

        debitCards = new ArrayList<>();
        creditCards = new ArrayList<>();
        accountsBankList = new ArrayList<>();
    }
    ...
    public Account save(Account account) {
        account.setCode(String.valueOf(10 + accountsBankList.size()));
