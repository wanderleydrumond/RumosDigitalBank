 ...
 */
public class CustomerListServiceImplementation implements CustomerService {
    /**
     * Contains all methods from the persistence layer.
     */
    private CustomerRepository customerRepositoryImplementation;

    public CustomerListServiceImplementation(CustomerRepository customerRepository) {
